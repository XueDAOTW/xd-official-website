...
import { ArrowLeft, Calendar, Users, Trophy, Building } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-20 pb-12">
        ...
        >
          ...
          >
            <motion.div
              className="inline-block px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full text-sm font-medium mb-6"
              variants={fadeInVariants}
            >
              May 13 - June 30, 2024
            </motion.div>
            <motion.h1
              className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 bg-clip-text text-transparent"
              variants={fadeInVariants}
            >
              XueDAO CONNECT Hackathon 2024
            </motion.h1>
            <motion.p
              className="text-xl text-medium-contrast max-w-3xl mx-auto leading-relaxed mb-8"
              variants={fadeInVariants}
            >
              The XueDAO CONNECT Hackathon is the first student-only event in Taiwan, dedicated to showcasing the capabilities of Taiwanese students in web3 development!
            </motion.p>
          </motion.div>
